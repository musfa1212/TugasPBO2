...
class Window(QMainWindow):
    def __init__(self):
        ...
        # edit
        whitekAction = QAction(QIcon("icons/erase.png"), "Erase", self)
        whitekAction.setShortcut("Ctrl+E")
        edit.addAction(whitekAction)
        ...
        # brushSize
        onepxAction = QAction( QIcon("icons/one.png"), "1px", self)
        ...
        eightpxAction = QAction(QIcon("icons/eight.png"), "18px", self)
        brushSize.addAction(eightpxAction)
        eightpxAction.triggered.connect(self.eightpx)

        two4pxAction = QAction(QIcon("icons/two4.png"), "24px", self)
        brushSize.addAction(two4pxAction)
        two4pxAction.triggered.connect(self.two4px)
